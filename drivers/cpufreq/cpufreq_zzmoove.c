					  ...
					  const char *buf, size_t count)
{
	...
	int ret;
	int i=0;
	int valid_freq[16]={0, 1700000, 1664000, 1600000, 1500000, 1400000, 1300000, 1200000, 1100000, 1000000, 900000, 800000, 700000, 600000, 500000, 400000, 300000, 200000, 100000, 50000};
	ret = sscanf(buf, "%u", &input);
