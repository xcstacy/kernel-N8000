...
#define EXP_1 (FIXED_1-((FIXED_1*LOAD_FREQ)/(LOAD_FREQ/5*60UL)))
#define EXP_5 (FIXED_1-((FIXED_1*LOAD_FREQ)/(LOAD_FREQ*1*60UL)))
#define EXP_15 (FIXED_1-((FIXED_1*LOAD_FREQ)/(LOAD_FREQ*3*60UL)))
